...
import aboutOne from '../../assets/images/thumbs/aboutOne.webp'
import aboutTwo from '../../assets/images/thumbs/aboutTwo.webp'
...
function About() {
    return (
        <div id="box" className='about'>
            <h2>About</h2>
            <article >
                <img className="leftImage" src={aboutOne} alt="Cassidy" />
                ...
                <img className="rightImage" src={aboutTwo} alt="Cassidy" />
